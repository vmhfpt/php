...
if(!empty($_GET)){
    ...
    $sql = "SELECT `product`.`name`, `product`.`thumb`, `product`.`price`, `product`.`price_sale`, `product`.`slug` FROM `product`  WHERE `name` LIKE '%".$key."%' ";
      ...
      <section class="app-bread-crumb container-fluid">
        <div class="container">
          <ul class="">
            ...
            <li class=""><a href="" class="">Tìm kiếm</a> /</li>
            <li class=""><a href="" class=""><?=$key?></a></li>
          </ul>
        </div>
      </section>
          ...
          <div class="container-filter__brand">
            <div class="container-filter__brand-content">
              ...
              <div class="container-filter__brand-content-list">
                <ul>
                  <a class="select-category" href="category.php?ca=iphone-chinh-hang" data-filter="iphone-chinh-hang">
                    <li>
                  ...
                  <a class="select-category" href="category.php?ca=samsung-tab" data-filter="samsung-tab" >
                    <li>   <div class="container-filter__brand-content-list-btn">
                       Tab SAMSUNG
                    </div></li>
                  </a>
                  <a class="select-category" href="category.php?ca=samsung" data-filter="samsung" >
                    <li> <div class="container-filter__brand-content-list-btn">
                        <img src="https://didongthongminh.vn/images/products/cat/original/image-117-1_1669949433.svg" alt="" class="">
                    </div></li>
                  </a>
                  <a  class="select-category" href="category.php?ca=xiaomi" data-filter="xiaomi">
                    <li> <div class="container-filter__brand-content-list-btn">
                        <img src="https://didongthongminh.vn/images/products/cat/original/image-117-2_1669949465.svg" alt="" class="">
                    </div></li>
                  </a>
                  <a class="select-category" href="category.php?ca=ipad-ios" data-filter="ipad-ios" >
                    <li> <div class="container-filter__brand-content-list-btn">
                        Tab IOS
                    </div></li>
                  </a>
                  ...
                  <a class="select-category" href="category.php?ca=tai-nghe" data-filter="tai-nghe" >
                    <li> <div class="container-filter__brand-content-list-btn">
                       Tai Nghe
                    </div></li>
                  </a>
                  ...
                  <a class="select-category" href="category.php" data-filter="all">
                    <li> <div class="container-filter__brand-content-list-btn">
                      Tất Cả
                    </div></li>
                  </a>
